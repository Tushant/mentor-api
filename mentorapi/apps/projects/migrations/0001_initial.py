    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=10)),
        ...
        migrations.AddField(
            model_name='project',
            name='work_process',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='services.WorkingProcess'),
        ),
    ]
