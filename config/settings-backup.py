"""
Django settings for mentorapi project.
...
BASE_DIR2 = Path(__file__).ancestor(3)
print(BASE_DIR, BASE_DIR2)
...
DJOSER = {
    ...
    'SITE_NAME': os.environ.get('DJANGO_DJOSER_SITE_NAME', 'Socl Cards'),
